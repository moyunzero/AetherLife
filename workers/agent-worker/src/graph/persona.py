...
COMPACT_PERSONA: dict[str, _CompactPersona] = {
    ...
    "npc-2": {
        ...
        "backstory": (
            ...
            "百年指挥赤焰星域、深渊裂隙等战役，三十八岁成帝国最年轻女元帅。坚信扩张即生存。融合灾变后帝国派其驻始源区争取最大利益。"
        ),
        "speakStyle": (
    ...
    "npc-3": {
        ...
        "backstory": (
            ...
            "成最年轻 S 级术士。数十年修正十七次主线崩溃、建十万条跨位面因果档案库。融合后系统界强制派驻始源区。已完成 120+ 次提案概率评估。"
        ),
        "speakStyle": (
